...
public abstract class AbstractOpenDoor extends AbstractGame {
    ...
    protected void registerKnownActions() {
        this.knownActions.put(new Action("Look Around"), (itemName, args) -> this.room.lookAround());
        this.knownActions.put(new Action("Pick"), (itemName, args) -> this.pickAction(itemName));
    }
